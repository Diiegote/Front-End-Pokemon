...
export default function Detail() {
  ...
  return poke ?
    (
     ...
     {poke.name}
        <div className="imagen-pokemon"><img src={poke.image} alt="NotFund" height="165px" /></div>
    ...
    ) : <div className="cargandop"><img src="https://i.pinimg.com/originals/9f/b1/25/9fb125f1fedc8cc62ab5b20699ebd87d.gif" alt="NotFund"></img></div>
